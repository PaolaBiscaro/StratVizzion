...
const ViewKeyResults = () => {
    ...
    const data = [
        ...
        { id: 2, name: "KR-02", title: "Aumentar em 10% os novos clientes", okr: "OKR002", deadline: "08 Ago 2026", value: "61k", goal: "75k", progress: 60 },
        { id: 3, name: "KR-02", title: "Aumentar DAU de 50k para 75k até 30/jun", okr: "OKR003", deadline: "25 Nov 2026", value: "61k", goal: "75k", progress: 60 },
    ];
                    ...
                    {data.map(kr => (
                        <div key={kr.id} className="kr-card-container">
                            <div className="kr-card-top">
                                <KRTag name={kr.name} title={kr.title} okr={kr.okr} onClick={() => navigate(`/kr-detalhada`)}/>
